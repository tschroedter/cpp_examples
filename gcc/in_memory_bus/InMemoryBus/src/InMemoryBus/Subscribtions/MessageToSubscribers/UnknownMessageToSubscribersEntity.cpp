...
UnknownMessageToSubscribers::UnknownMessageToSubscribers()
...
string UnknownMessageToSubscribers::get_message_type() const {
  return (m_message_type);
}

IThreadSafeSubscriberInformationRepository_SPtr UnknownMessageToSubscribers::get_repository() const {
