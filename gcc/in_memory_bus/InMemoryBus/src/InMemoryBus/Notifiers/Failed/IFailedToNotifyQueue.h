...
#ifndef SRC_INMEMORYBUS_NOTIFIERS_FAILED_IFAILEDTONOTIFYQUEUE_H_
#define SRC_INMEMORYBUS_NOTIFIERS_FAILED_IFAILEDTONOTIFYQUEUE_H_
...
#endif /* SRC_INMEMORYBUS_NOTIFIERS_FAILED_IFAILEDTONOTIFYQUEUE_H_ */
