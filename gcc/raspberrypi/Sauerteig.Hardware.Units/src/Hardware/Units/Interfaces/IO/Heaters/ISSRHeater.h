...
#ifndef HARDWARE_UNITS_INTERFACES_IO_HEATERS_ISSRHEATER_H_
#define HARDWARE_UNITS_INTERFACES_IO_HEATERS_ISSRHEATER_H_
...
#endif /* HARDWARE_UNITS_INTERFACES_IO_HEATERS_ISSRHEATER_H_ */
