...
void Installer::register_components(Hypodermic::ContainerBuilder& builder) {
    ...
    builder.registerType<IO::AnalogeDigitalConverters::ADC0832>()
            .as<Interfaces::IO::AnalogeDigitalConverters::IADC0832>();
    builder.registerType<IO::Sensors::Tmp36>()
            .as<Interfaces::IO::Sensors::ITmp36>();
    builder.registerType<IO::Sensors::Tmp36Logic>()
            .as<Interfaces::IO::Sensors::ITmp36Logic>();
    builder.registerType<IO::SerialShiftRegisters::SSR74HC595>()
            .as<Interfaces::IO::SerialShiftRegister::I74HC595>();
}
