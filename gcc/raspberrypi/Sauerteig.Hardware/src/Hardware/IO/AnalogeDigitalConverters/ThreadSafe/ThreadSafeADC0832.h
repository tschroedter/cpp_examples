...
#ifndef HARDWARE_IO_ANALOGEDIGITALCONVERTERS_THREADSAFE_THREADSAFEADC0832_H_
#define HARDWARE_IO_ANALOGEDIGITALCONVERTERS_THREADSAFE_THREADSAFEADC0832_H_
