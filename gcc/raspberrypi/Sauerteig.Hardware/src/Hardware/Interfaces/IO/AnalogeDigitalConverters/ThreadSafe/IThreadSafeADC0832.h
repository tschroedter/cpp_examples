...
#ifndef HARDWARE_INTERFACES_IO_ANALOGEDIGITALCONVERTERS_THREADSAFE_ITHREADSAFEADC0832_H_
#define HARDWARE_INTERFACES_IO_ANALOGEDIGITALCONVERTERS_THREADSAFE_ITHREADSAFEADC0832_H_
