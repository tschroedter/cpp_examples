...
#ifndef SRC_INTERFACES_MONITORS_TEMPERATURES_ITEMPERATURESMESSAGEHANDLER_H_
#define SRC_INTERFACES_MONITORS_TEMPERATURES_ITEMPERATURESMESSAGEHANDLER_H_
...
#endif /* SRC_INTERFACES_MONITORS_TEMPERATURES_ITEMPERATURESMESSAGEHANDLER_H_ */
