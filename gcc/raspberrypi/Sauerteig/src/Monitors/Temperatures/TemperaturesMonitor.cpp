...
string TemperaturesMonitor::to_string() const {
    ...
    string outside = m_converter->convert(outside_value, outside_percent);

    string message = "Current temperatures (Inside, Outside): " + inside + ", " + outside;
