...
#ifndef SRC_INMEMORYBUS_NOTIFIERS_FAILED_FAILEDTONOTIFY_H_
#define SRC_INMEMORYBUS_NOTIFIERS_FAILED_FAILEDTONOTIFY_H_
...
#endif /* SRC_INMEMORYBUS_NOTIFIERS_FAILED_FAILEDTONOTIFY_H_ */
