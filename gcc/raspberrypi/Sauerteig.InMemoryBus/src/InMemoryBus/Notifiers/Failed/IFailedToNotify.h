...
#ifndef SRC_INMEMORYBUS_NOTIFIERS_FAILED_IFAILEDTONOTIFY_H_
#define SRC_INMEMORYBUS_NOTIFIERS_FAILED_IFAILEDTONOTIFY_H_
...
#endif /* SRC_INMEMORYBUS_NOTIFIERS_FAILED_IFAILEDTONOTIFY_H_ */
